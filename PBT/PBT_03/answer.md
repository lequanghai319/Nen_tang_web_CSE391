...
3.  Sản phẩm B" (thẻ h2):
    ...
    - Giải thích: Thẻ tiêu đề `h2` này không bị bất kỳ class hay ID nào ghi đè màu trực tiếp. Do đó, nó tuân theo quy luật kế thừa (inheritance) tự nhiên trong CSS và lấy màu từ thẻ cha gần nhất bọc nó là khối `.card` (đang được set `color: blue`).
